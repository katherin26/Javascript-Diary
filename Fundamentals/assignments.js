...
if (language === 'english' && population < 50 && !isIsland) {
  ...
  console.log(`Greece does not meet all the criteria =(`);
}
...
1. If you country's population is greater than 33 million , use the ternary operator to log a string like
this to the console: `Greece's population is above average`. Otherwise , simply log `Greece's population is 
